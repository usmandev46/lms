...
void showCourseEnrollmentsReportsFilterDialog(
    BuildContext context, {
      required CourseEnrollmentsController controller,
    }) {
  showDialog(
    context: context,
        ...
        child: AnimatedScale(
          ...
          child: Material(
            ...
            child: Container(
              ...
              child: Obx(() {
                CourseEnrollmentsFilterData filter = controller.courseEnrollmentsFilterList.value!.data;
                return Column(
                      ...
                      child: SingleChildScrollView(
                        child: Column(
                          ...
                          children: [
                            ...
                            FilterDropdown<CourseEnrollmentsBatch>(
                            ...
                            FilterDropdown<CourseEnrollmentsClass>(
                            ...
                            FilterDropdown<CourseEnrollmentsCourse>(
                              icon: Icons.map_outlined,
                              label: "Course",
                            ...
                            FilterDropdown<CourseEnrollmentsStatus>(
                              icon: Icons.map_outlined,
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: controller.isLoading.isTrue
                              ...
                              Future.microtask(() {
                                ...
                                controller.courseEnrollmentsReportsFun();
                              });
                            },
                            child: MyText(
