...
import '../widget/show_quiz_report_dialog.dart';

class QuizReportsView extends StatelessWidget {
  const QuizReportsView({super.key});
    ...
    return Scaffold(
        appBar: customHomeAppBar(
          ...
          suffixIcon: GestureDetector(
            onTap: () {
              showQuizReportsFilterDialog(context, controller: controller);
            },
        ...
        return Column(
          children: [
              ...
              child: Stack(
                children: [
                  CustomDataTableAdvance(
                      columns: controller.quizReportsColumnList,
            ...
            PaginationWidget(
              ...
              onPageChange: (p) {
                controller.quizReportsFun(goToPage: p);
              },
            ),
          ],
        );
