...
void showClassReportsFilterDialog(
    BuildContext context, {
      required ClassReportsController controller,
    }) {
  showDialog(
    context: context,
        ...
        child: AnimatedScale(
          ...
          child: Material(
            ...
            child: Container(
              ...
              child: Obx(() {
                ClassReportsFilterData filter = controller.classReportsFilterList.value!.data;
                return Column(
                      ...
                      child: SingleChildScrollView(
                        child: Column(
                          ...
                          children: [
                            ...
                            FilterDropdown<ClassReportsFilterBatch>(
                            ...
                            FilterDropdown<ClassReportsFilterClass>(
                            ...
                            FilterDropdown<ClassReportsFilterCourse>(
                              icon: Icons.map_outlined,
                              label: "Course",
                            ...
                            FilterDropdown<ClassReportsFilterStatus>(
                              icon: Icons.map_outlined,
